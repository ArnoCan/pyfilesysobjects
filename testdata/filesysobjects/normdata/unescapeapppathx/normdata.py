    ...
    def calltests(self,**kargs):
        ...
        for i in range(f,l):
            ...
            try:
                ...
                ret0 = escapepathx(norm_data[i], tpf=self.curtpf, **kwargs)
...
#                 print("4TEST:     r'" + str(ret) + "',")
                ...
                self.assertEqual(ret0, self.norm_result[i])  # escape it

                ret1 = unescapepathx(ret0, tpf=self.curtpf, **kwargs)
                self.assertEqual(ret1, norm_data[i])  # unescape it, should be the raw input
                ...
                sys.stderr.write(("  <-  GOT(e):    escapepathx()[%3d]   = '%s'\n")%(i,str(ret0)))
                sys.stderr.write(("  <-  GOT(u):    unescapepathx()[%3d] = '%s'\n")%(i,str(ret1)))
                ...
                sys.stderr.write("# ORIGINAL EXCEPTION: \n" + str(e) + "\n")
