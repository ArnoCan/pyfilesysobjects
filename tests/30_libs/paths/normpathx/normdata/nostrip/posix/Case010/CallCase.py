...
import testdata.filesysobjects.normdata.normpathx.pathnames.data
norm_data_source = testdata.filesysobjects.normdata.normpathx.pathnames.data.__file__
...
class CallUnits(normdata.CallUnitsBase):
    ...
    def setUp(self):
        ...
        self.curspf = myspf
        """Assigns the current call type for conversion parameter of normpathx(spf=myspf)."""
    ...
    def testCase_00(self):
        # self.calltests(single=24,strip=False)
        pass
    
    def testCase_01(self):
        # 
        self.calltests(single=120,strip=False)
#        self.calltests(single=143,strip=False)
        pass

    def testCase_10(self):
        # self.calltests(first=177,last=201,strip=False)
        pass
