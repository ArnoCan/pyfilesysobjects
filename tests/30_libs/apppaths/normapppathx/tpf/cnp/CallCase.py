...
class UseCase(unittest.TestCase):
    ...
    def testCase001(self):
        ...
        res = normapppathx(arg, spf='win', apppre=False)
    ...
    def testCase002(self):
        ...
        res = normapppathx(arg, spf='win', tpf='local', apppre=False)
    ...
    def testCase003(self):
        ...
        arg = 'd:/:d:/'
        resX = 'd:/:d:'
        res = normapppathx(arg, spf='win', tpf='cnp', apppre=False)
        self.assertEqual(res, resX)
    ...
    def testCase006(self):
        ...
        arg = 'd:\\;d:'
        resX = 'd:\\:d:'
        res = normapppathx(arg, spf='win', tpf='cnp', apppre=False, delnulpsep=False)
        self.assertEqual(res, resX)
