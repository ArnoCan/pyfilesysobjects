...
class CallUnits(unittest.TestCase):
    ...
    def testCase110(self):
        ...
        res = filesysobjects.apppaths.normapppathx(arg, spf='posix')
    ...
    def testCase120(self):
        ...
        res = filesysobjects.apppaths.normapppathx(arg, spf='posix', apppre=True)
        self.assertEqual(res, resX )
    ...
    def testCase200(self):
        ...
        res = filesysobjects.apppaths.normapppathx(arg, spf='posix', apppre=True)
        self.skipTest("Basically an error - but actually exotic and rare.")
