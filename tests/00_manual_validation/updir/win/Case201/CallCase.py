...
class CallUnits(unittest.TestCase):
    ...
    def testCase110(self):
        ...
        res = filesysobjects.apppaths.normapppathx(arg, spf='win', tpf='win')
        self.assertEqual(res, resX )

    def testCase120(self):
        arg = r'file:////\\\\\\.\\\\/file_at_current_dir/sub0'  # needs to be exact
        resX = r'file:///file_at_current_dir/sub0'

        res = filesysobjects.apppaths.normapppathx(arg, spf='win', apppre=True, tpf='win')
        self.assertEqual(res, resX )
